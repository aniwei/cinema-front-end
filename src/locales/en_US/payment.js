export default {
  'payment.title.success': `Payment successful`,
  'payment.title.fail': `Payment failure`,
  'payment.content.tradeNumber': 'Transaction record:',
